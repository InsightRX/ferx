...
#' @export
ferx_rust_fit <- function(model_path, data_path, method, maxiter, covariance, verbose, bloq_method, threads, settings_keys, settings_values) {
  .Call("wrap__ferx_rust_fit", model_path, data_path, as.character(method), maxiter, covariance, verbose, bloq_method, threads, as.character(settings_keys), as.character(settings_values))
}
